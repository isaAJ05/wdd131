...
document.getElementById("quote-text").textContent = getQuoteOfTheDay();
 ...
 // Scriptures
    ...
    const s = scriptures[scriptureIndex];
    let scriptureText= document.getElementById('scripture-text').textContent = s.text;
    scriptureTextdocument.getElementById('scripture-ref').textContent = s.ref;
    }
    document.getElementById('next-scripture').addEventListener('click', () => {
