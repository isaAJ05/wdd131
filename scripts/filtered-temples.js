...
function display(temples, nameGiven) {
    templeSection.innerHTML = ""; 
    const name1 = document.createElement("h2");
    name1.textContent = nameGiven;
    templeSection.appendChild(name1);
